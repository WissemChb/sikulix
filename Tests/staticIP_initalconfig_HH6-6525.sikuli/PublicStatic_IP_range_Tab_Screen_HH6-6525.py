...
#def brodband_IP_address():
 #   click("1499779885733.png")
 #   click("1499779916916.png")
  #  if exists("1499779973017.png"):
 #       BrAdress = find("1499779983199.png").text().split('.')
 #       public_static_ip_range_tab_screen(BrAdress[0],BrAdress[1],BrAdress[2],BrAdress[3],'Broadband address should not be assigned')
